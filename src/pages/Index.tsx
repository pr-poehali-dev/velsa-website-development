...
const LOGO_URL = "https://cdn.poehali.dev/projects/bdb971cd-983a-480d-9dc0-ed1ce8b46e0d/bucket/fedd52d2-6b85-433d-88fa-8611372614ca.JPG";
...
export default function Index() {
  ...
  return (
    <div className="bg-[#0C0B09] text-white min-h-screen font-body overflow-x-hidden">

      {/* ───── TICKER ───── */}
      <div className="bg-velsa-blue text-[#E8B86D] border-b border-[#C8973A]/20 py-1.5 overflow-hidden relative z-50">
      ...
      <nav className="fixed top-6 left-0 right-0 z-40 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-1 bg-[#141210]/90 backdrop-blur-md border border-[#C8973A]/10 rounded-none px-2 py-1.5">
            {NAV_LINKS.map((l) => (
              <a
                key={l.href}
                href={l.href}
          ...
          <a
            href="#testdrive"
            className="hidden lg:flex items-center gap-2 bg-[#C8973A] text-[#0C0B09] font-heading font-semibold text-xs tracking-[0.15em] uppercase px-5 py-2.5 hover:bg-[#E8B86D] transition-all"
          >
        ...
        {menuOpen && (
          <div className="lg:hidden mt-2 bg-[#141210]/95 backdrop-blur-md border border-[#C8973A]/15 p-4 mx-0">
            {NAV_LINKS.map((l) => (
              <a
                key={l.href}
                href={l.href}
                onClick={() => setMenuOpen(false)}
                className="block font-heading text-sm tracking-widest uppercase py-3 text-white/70 hover:text-[#E8B86D] border-b border-white/5 transition-colors"
              >
                {l.label}
              </a>
            ))}
            <a href="#testdrive" className="block mt-4 bg-[#C8973A] text-[#0C0B09] font-heading font-semibold text-xs tracking-widest uppercase text-center py-3">
      ...
      <section id="hero" className="relative min-h-screen flex items-center overflow-hidden speed-lines-bg">
        <div className="absolute inset-0">
          <img
            ...
            style={{ filter: "saturate(0.2) sepia(0.3) contrast(1.2)" }}
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0C0B09] via-[#0C0B09]/85 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0C0B09] via-transparent to-[#0C0B09]/50" />
        </div>
        ...
        <div className="absolute right-0 top-0 bottom-0 w-1/2 pointer-events-none overflow-hidden">
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="absolute h-px bg-gradient-to-r from-transparent via-[#C8973A]/15 to-transparent animate-speed-line"
              style={{
                top: `${15 + i * 10}%`,
                left: "20%",
                right: 0,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-24">
          <div className="max-w-3xl">
            ...
            <div
              ...
              style={{ animationFillMode: "both" }}
            >
              <div className="h-px w-16 bg-[#C8973A]" />
              <span className="font-heading text-[#C8973A] text-sm tracking-widest uppercase">Скорость. Мощь. Свобода.</span>
            </div>
            <p
            ...
            >
              <a
                href="#catalog"
                className="group flex items-center gap-3 bg-[#C8973A] text-[#0C0B09] font-heading font-semibold tracking-[0.15em] uppercase px-8 py-4 hover:bg-[#E8B86D] transition-all animate-pulse-neon"
              >
                Смотреть каталог
              ...
              <a
                href="#gallery"
                className="flex items-center gap-3 border border-[#C8973A]/30 text-white/80 font-heading font-medium tracking-[0.15em] uppercase px-8 py-4 hover:border-[#C8973A] hover:text-[#E8B86D] transition-all"
              >
            ...
            >
              {[["3", "модели"], ["70+", "км/ч"], ["150", "км пробег"], ["5000+", "клиентов"]].map(([num, lbl]) => (
                <div key={lbl}>
                  <div className="font-display text-3xl text-[#C8973A] leading-none">{num}</div>
                ...
                <div className="group bg-[#111] neon-border-hover cursor-pointer relative overflow-hidden">
                  <div className="relative overflow-hidden h-64">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: model.color, color: model.color === "#1E3A5F" ? "#E8B86D" : "#0C0B09" }}
                    >
                      {model.tag}
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-6">
                      {[
                        ...
                        <div key={s.label} className="bg-[#0C0B09] p-3 text-center">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-display text-2xl text-[#C8973A]">{model.price}</span>
                      <button className="flex items-center gap-2 font-heading text-xs tracking-widest uppercase text-white/60 hover:text-[#E8B86D] transition-colors group">
                        Подробнее
      ...
      {/* ───── SPECS ───── */}
      <section id="specs" className="py-24 px-6 bg-[#100F0D] relative speed-lines-bg">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimSection>
              ...
              <a
                href="#testdrive"
                className="inline-flex items-center gap-3 bg-[#C8973A] text-[#0C0B09] font-heading font-semibold tracking-[0.15em] uppercase px-6 py-3 hover:bg-[#E8B86D] transition-all text-sm"
              >
            ...
            <AnimSection>
              <div className="grid grid-cols-2 gap-0.5">
                {SPECS.map((s, i) => (
                  <div
                    key={s.label}
                    className="bg-[#141210] p-5 neon-border-hover group"
            ...
            <div className="relative bg-[#111] overflow-hidden" style={{ paddingBottom: "42%" }}>
              <div className="absolute inset-0 flex items-center justify-center bg-[#111]">
                ...
                <div className="relative z-10 flex flex-col items-center gap-4">
                  <button className="w-20 h-20 bg-[#C8973A] flex items-center justify-center hover:bg-[#E8B86D] transition-all animate-pulse-neon">
                    <Icon name="Play" size={32} className="text-[#0C0B09] ml-1" />
                  </button>
            ...
            {[BIKE_IMG_1, BIKE_IMG_2, BIKE_IMG_1].map((img, i) => (
              <AnimSection key={i} className={`animate-delay-${(i + 1) * 100}`}>
                <div className="group relative overflow-hidden cursor-pointer" style={{ paddingBottom: "66%" }}>
                  ...
                  />
                  <div className="absolute inset-0 bg-[#0C0B09]/40 group-hover:bg-transparent transition-all duration-300" />
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="w-12 h-12 bg-[#C8973A]/90 flex items-center justify-center">
                      <Icon name={i === 1 ? "Play" : "ZoomIn"} size={20} className="text-[#0C0B09]" />
                    </div>
                  </div>
                  <div className="absolute bottom-3 left-3">
                    <span className="font-heading text-[10px] tracking-widest uppercase text-[#E8B86D] bg-[#0C0B09]/80 px-2 py-1">
      ...
      {/* ───── TEST DRIVE ───── */}
      <section id="testdrive" className="py-24 px-6 bg-[#100F0D] relative overflow-hidden">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-1/2 pointer-events-none overflow-hidden">
          <img
            ...
            style={{ filter: "saturate(0) sepia(0.3) contrast(1.3)" }}
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#100F0D] via-[#100F0D]/50 to-transparent" />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <AnimSection>
              {submitted ? (
                <div className="bg-[#141210] p-10 flex flex-col items-center justify-center text-center neon-border h-full min-h-[400px]">
                  <div className="w-16 h-16 bg-[#C8973A] flex items-center justify-center mb-6">
                    <Icon name="CheckCheck" size={32} className="text-[#0C0B09]" />
                  </div>
                ...
                <form onSubmit={handleSubmit} className="bg-[#141210] border border-[#C8973A]/10 p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0C0B09] border border-[#C8973A]/15 text-white font-body px-4 py-3 focus:border-[#C8973A] focus:outline-none transition-colors placeholder:text-white/20"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#0C0B09] border border-[#C8973A]/15 text-white font-body px-4 py-3 focus:border-[#C8973A] focus:outline-none transition-colors"
                    >
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#C8973A] text-[#0C0B09] font-heading font-bold tracking-[0.2em] uppercase py-4 hover:bg-[#E8B86D] transition-all mt-2 flex items-center justify-center gap-2"
                  >
              ...
              <AnimSection key={i} className={`animate-delay-${(i + 1) * 100}`}>
                <article className="bg-[#111] p-6 neon-border-hover cursor-pointer h-full flex flex-col">
                  <div className="flex items-center justify-between mb-4">
                    <span className="bg-[#C8973A]/10 text-[#C8973A] font-heading text-[10px] tracking-widest uppercase px-3 py-1">
                      {post.tag}
                    </span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="font-heading text-xs tracking-wider uppercase text-[#C8973A]/60 hover:text-[#E8B86D] flex items-center gap-1 transition-colors">
      ...
      {/* ───── ABOUT ───── */}
      <section id="about" className="py-24 px-6 bg-[#100F0D] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimSection>
              <div className="relative">
                ...
                />
                <div className="absolute bottom-6 left-6 bg-[#1E3A5F] border border-[#C8973A]/40 p-5">
                  <div className="font-display text-4xl text-[#C8973A] leading-none">2018</div>
                  <div className="font-heading text-xs tracking-widest uppercase text-[#C8973A]/60">Год основания</div>
                </div>
              </div>
            </AnimSection>
            ...
            <AnimSection>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[["5000+", "Клиентов"], ["3", "Модели"], ["26", "Дилеров"]].map(([num, lbl]) => (
                  <div key={lbl} className="border-t border-[#C8973A]/30 pt-4">
                    <div className="font-display text-3xl text-[#C8973A]">{num}</div>
      ...
      <section id="contacts" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-0.5">
            {[
              ...
              <AnimSection key={c.label}>
                <div className="bg-[#141210] p-6 neon-border-hover h-full">
                  <Icon name={c.icon} fallback="CircleAlert" size={20} className="text-[#C8973A] mb-4" />
          ...
          <AnimSection className="mt-0.5">
            <div className="bg-[#1E3A5F] border border-[#C8973A]/30 p-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="font-display text-3xl text-[#E8B86D] tracking-wider">СТАТЬ ДИЛЕРОМ</h3>
                <p className="font-body text-white/50 text-sm mt-1">Открой свою точку продаж ВЕЛСА в своём городе</p>
              </div>
              <button className="flex-shrink-0 flex items-center gap-2 bg-[#C8973A] text-[#0C0B09] font-heading font-bold tracking-widest uppercase px-8 py-4 hover:bg-[#E8B86D] transition-colors">
      ...
      {/* ───── FOOTER ───── */}
      <footer className="border-t border-[#C8973A]/10 py-10 px-6 bg-[#0C0B09]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <a href="#hero">
            <img
              ...
              style={{ filter: "invert(1) sepia(1) saturate(2) hue-rotate(5deg) brightness(0.75)" }}
            />
          </a>
          ...
          <div className="flex gap-3">
            {["Instagram", "Youtube", "MessageCircle"].map((ico) => (
              <button key={ico} className="w-9 h-9 border border-[#C8973A]/20 flex items-center justify-center text-white/40 hover:border-[#C8973A] hover:text-[#C8973A] transition-all">
                <Icon name={ico} fallback="CircleAlert" size={16} />
              </button>
            ))}
          </div>
        </div>
        <div className="max-w-7xl mx-auto mt-6 pt-6 border-t border-[#C8973A]/8 flex flex-col md:flex-row items-center justify-between gap-2">
